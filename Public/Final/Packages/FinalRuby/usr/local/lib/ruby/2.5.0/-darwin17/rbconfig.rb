...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host=aarch64-apple-darwin17' '--build=x86_64-unknown-linux-gnu' '--with-baseruby=/usr/bin/ruby' '--with-static-linked-ext' '--enable-load-relative' '--disable-werror' '--enable-shared' 'build_alias=x86_64-unknown-linux-gnu' 'host_alias=aarch64-apple-darwin17'"
  ...
  CONFIG["LDFLAGS"] = "-isysroot/usr/SDK -L/usr/lib -L/usr/local/lib -L/lib -L. -fstack-protector"
