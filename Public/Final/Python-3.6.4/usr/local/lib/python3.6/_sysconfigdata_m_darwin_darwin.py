...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'clang -bundle -lpython3.6m -isysroot/usr/SDK ',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-I/include -I/usr/include -I/usr/local/include '
           '-I/usr/SDK/usr/include -isysroot/usr/SDK -g -O3 -Wall -fwrapv -Wstrict-prototypes',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--host=aarch64-apple-darwin17' '--build=x86_64-apple-darwin' "
                "'--with-sysroot=/home/cade/toolchain/SDK/usr/' "
                "'--enable-shared' '--enable-static' 'ac_cv_file__dev_ptmx=no' "
                "'ac_cv_file__dev_ptc=no' '--disable-ipv6' '--with-system-ffi' "
                "'--with-ensurepip=yes' 'build_alias=x86_64-apple-darwin' "
                "'host_alias=aarch64-apple-darwin17'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.6m',
 'COREPYTHONPATH': ':',
 'COVERAGE_INFO': '/home/cade/build/old/Python-3.6.4/coverage.info',
 'COVERAGE_REPORT': '/home/cade/build/old/Python-3.6.4/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': ' -O3 -g -Wall -I/include -I/usr/include -I/usr/local/include'
             '-I/usr/SDK/usr/include -isysroot/usr/SDK/',
 'CXX': 'clang++',
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'aarch64-apple-darwin17',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'clang -bundle -lpython3.6m -isysroot/usr/SDK/ ',
 'LDVERSION': '3.6m',
 'LIBC': '',
 ...
 'LIBPL': '/usr/local/lib/python3.6/config-3.6m-darwin',
 'LIBRARY': 'libpython3.6m.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-ldl -lpython3.6m',
 ...
 'PYTHONPATH': ':',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/cade/build/old/Python-3.6.4 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/cade/build/old/Python-3.6.4/`cat '
                     'pybuilddir.txt`:)./Lib '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   '-DNDEBUG -g -fwrapv -O3 -Wall -Wstrict-prototypes -std=c99 '
 ...
 'abs_builddir': '/home/cade/build/old/Python-3.6.4',
 'abs_srcdir': '/home/cade/build/old/Python-3.6.4',
